...
hide_title: true
keywords: ["advanced", "math", "software architecture", "design patterns", "best practices"]
tags: ["algorithms and data structures", "math and number theory", "advanced", "math"]
---

<Hero
  title="Advanced Math"
  subtitle="Fast exponentiation, matrix exponentiation, Fibonacci, and advanced number theory"
  imageAlt="Advanced Math illustration"
  size="large"
/>
