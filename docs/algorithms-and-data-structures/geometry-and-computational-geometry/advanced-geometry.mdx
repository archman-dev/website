...
hide_title: true
keywords: ["advanced", "geometry", "software architecture", "design patterns", "best practices"]
tags: ["algorithms and data structures", "geometry and computational geometry", "advanced", "geometry"]
---

<Hero
  title="Advanced Geometry"
  subtitle="Sweep line algorithm, closest pair of points, line segment intersection, polygon operations, and 3D geometry basics"
  imageAlt="Advanced Geometry illustration"
  size="large"
/>
