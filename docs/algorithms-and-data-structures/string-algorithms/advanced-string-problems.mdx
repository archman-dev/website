...
hide_title: true
keywords: ["advanced", "string", "problems", "software architecture", "design patterns", "best practices"]
tags: ["algorithms and data structures", "string algorithms", "advanced", "string", "problems"]
---

<Hero
  title="Advanced String Problems"
  subtitle="Longest common substring, longest palindromic substring, string compression, and edit distance"
  imageAlt="Advanced String Problems illustration"
  size="large"
/>
