...
hide_title: true
keywords: ["scalable", "algorithm", "design", "software architecture", "design patterns", "best practices"]
tags: ["algorithms and data structures", "system design for algorithms", "scalable", "algorithm", "design"]
---

<Hero
  title="Scalable Algorithm Design"
  subtitle="Distributed algorithms, parallel processing, MapReduce patterns, stream processing, and caching strategies"
  imageAlt="Scalable Algorithm Design illustration"
  size="large"
/>
