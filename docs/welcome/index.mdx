...
## Skill‑based quick paths

Use this compact view if you prefer a level‑based progression.

<Tabs groupId="skill-level" defaultValue="beginner">
  <TabItem value="beginner" label="Beginner">
    <ul className="margin-left--md">
      <li className="margin-vert--sm">
        <Link to="/docs/foundational-concepts">Foundational Concepts</Link>
      </li>
      <li className="margin-vert--sm">
        <Link to="/docs/core-design-and-programming-principles">
          Core Design & Programming Principles
        </Link>
      </li>
      <li className="margin-vert--sm">
        <Link to="/docs/design-patterns">Design Patterns</Link> →{" "}
        <Link to="/docs/architectural-styles">Architectural Styles</Link>
      </li>
      <li className="margin-vert--sm">
        <Link to="/docs/testing-strategy">Testing Strategy</Link> →{" "}
        <Link to="/docs/observability-and-operations">
          Observability & Operations
        </Link>
      </li>
      <li className="margin-vert--sm">
        <Link to="/docs/security-architecture">Security Architecture</Link>
      </li>
    </ul>
  </TabItem>
  <TabItem value="intermediate" label="Intermediate">
    <ul className="margin-left--md">
      <li className="margin-vert--sm">
        ...
        <Link to="/docs/distributed-systems-and-microservices/fundamentals">
          Distributed Systems → Fundamentals
        </Link>{" "}
        →{" "}
        <Link to="/docs/distributed-systems-and-microservices/communication">
          Communication
        </Link>
      </li>
      <li className="margin-vert--sm">
        APIs:{" "}
        <Link to="/docs/api-and-interface-design/restful-api-design">
          RESTful API Design
        </Link>{" "}
        →{" "}
        <Link to="/docs/api-and-interface-design/restful-api-design/error-formats-and-problem-details">
          Error Formats
        </Link>{" "}
        →{" "}
        <Link to="/docs/api-and-interface-design/versioning-strategies">
          Versioning
        </Link>
      </li>
      <li className="margin-vert--sm">
        Data:{" "}
        <Link to="/docs/data-architecture-and-persistence/storage-models">
          Storage Models
        </Link>{" "}
        →{" "}
        <Link to="/docs/data-architecture-and-persistence/data-modeling-and-access">
          Modeling & Access
        </Link>
      </li>
      <li className="margin-vert--sm">
        Domain modeling:{" "}
        <Link to="/docs/domain-driven-design/strategic-design">
          DDD → Strategic
        </Link>{" "}
        → <Link to="/docs/domain-driven-design/tactical-design">Tactical</Link>
      </li>
      <li className="margin-vert--sm">
        Delivery & qualities:{" "}
        <Link to="/docs/delivery-engineering">Delivery Engineering</Link> →{" "}
        <Link to="/docs/quality-attributes/performance-and-scalability">
          Performance & Scalability
        </Link>{" "}
        →{" "}
        <Link to="/docs/quality-attributes/availability-and-reliability">
  ...
  <TabItem value="advanced" label="Advanced">
    <ul className="margin-left--md">
      <li className="margin-vert--sm">
        Resilience at scale:{" "}
        <Link to="/docs/distributed-systems-and-microservices/resilience-and-reliability-patterns">
          Resilience & Reliability Patterns
        </Link>
      </li>
      <li className="margin-vert--sm">
        Runtime/topology:{" "}
        <Link to="/docs/cloud-native-and-runtime-topology">
          Cloud‑Native & Runtime Topology
        </Link>
      </li>
      <li className="margin-vert--sm">
        Deep security:{" "}
        <Link to="/docs/security-architecture/identity-and-access">
          Identity & Access
        </Link>{" "}
        →{" "}
        <Link to="/docs/security-architecture/data-protection">
          Data Protection
        </Link>
      </li>
      <li className="margin-vert--sm">
        Org & governance:{" "}
        <Link to="/docs/architecture-governance-and-organization">
          Architecture Governance & Organization
        </Link>
      </li>
      <li className="margin-vert--sm">
        Change at scale:{" "}
        <Link to="/docs/modernization-and-migration">
          Modernization & Migration
        </Link>
      </li>
      <li className="margin-vert--sm">
        Choose a domain:{" "}
        <Link to="/docs/specialized-domains-architecture-considerations">
          Specialized Domains
        </Link>
      </li>
    </ul>
