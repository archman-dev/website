...
<Head>
  <meta
    name="description"
    content="Master the fundamentals of systems thinking for software architecture: components, connectors, configurations, interfaces, and abstractions to reason about change, risk, and evolution."
  />
  ...
  <meta
    ...
    content="Master the fundamentals of systems thinking for software architecture: components, connectors, configurations, interfaces, and abstractions to reason about change, risk, and evolution."
  />
  <meta property="og:image" content="https://archman.dev/img/foundational-concepts/system-thinking-basics.png" />
  ...
  <script type="application/ld+json">{JSON.stringify({
    ...
    "description": "Master the fundamentals of systems thinking for software architecture: components, connectors, configurations, interfaces, and abstractions to reason about change, risk, and evolution.",
    "image": "https://archman.dev/img/foundational-concepts/system-thinking-basics.png",
    "keywords": [
      "systems thinking",
      "components",
      "connectors",
