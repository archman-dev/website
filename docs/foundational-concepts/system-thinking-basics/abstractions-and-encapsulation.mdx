...
keywords: ["abstraction","encapsulation","information hiding","facade","boundaries","contracts","invariants","api gateway","bounded context","anti-corruption layer"]
image: /img/archman-social-card.webp
tags: ["abstractions","encapsulation","design-principles","system-boundaries","api-design","distributed-systems","observability","security","operations","reliability"]
hide_title: true
---

<Hero
  title="Abstractions & Encapsulation"
  subtitle="Use stable façades and information hiding to manage complexity, evolve safely, and enforce boundaries"
  imageAlt="System boundaries and abstraction layers illustration"
  size="large"
/>
