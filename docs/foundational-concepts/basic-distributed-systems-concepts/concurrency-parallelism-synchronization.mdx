---
sidebar_position: 2
title: Concurrency, Parallelism, Synchronization
description: Practical distinctions, decision flows, and patterns to combine concurrency, parallelism, and synchronization safely.
docType: deep-dive
...
tags: ["foundations","distributed-systems","concurrency","parallelism","synchronization","performance","reliability","latency","throughput","patterns"]
---
...
<Head>
  <meta name="description" content="Practical distinctions, decision flows, and patterns to combine concurrency, parallelism, and synchronization safely." />
  <meta property="og:title" content="Concurrency, Parallelism, Synchronization" />
  <meta property="og:description" content="Practical distinctions, decision flows, and patterns to combine concurrency, parallelism, and synchronization safely." />
  <meta property="og:image" content="https://archman.dev/img/docusaurus-social-card.jpg" />
  <meta name="twitter:card" content="summary_large_image" />
  <script type="application/ld+json">{JSON.stringify({
    "@context":"https://schema.org",
    "@type":"Article",
    "headline":"Concurrency, Parallelism, Synchronization",
    "description":"Practical distinctions, decision flows, and patterns to combine concurrency, parallelism, and synchronization safely.",
    "image":"https://archman.dev/img/docusaurus-social-card.jpg",
    "keywords":["concurrency","parallelism","synchronization","locks","async","threads","actors","backpressure","latency","throughput","Amdahl","Gustafson"],
  ...
  <script type="application/ld+json">{JSON.stringify({
    ...
    "itemListElement":[
      ...
      {"@type":"ListItem","position":3,"name":"Concurrency, Parallelism, Synchronization","item":"https://archman.dev/docs/foundational-concepts/basic-distributed-systems-concepts/concurrency-parallelism-synchronization"}
    ]
  })}</script>
</Head>
...
<Figure caption="Work-stealing: workers process local deques; idle workers steal from others">
...
<Showcase
  title="Applying concurrency, parallelism, and synchronization"
  sections={[
    {
      label: 'Signals',
      body: (
        <>
          <ul>
            <li>Workload characterized as I/O‑bound vs CPU‑bound; model chosen accordingly</li>
            <li>Concurrency bounded; queues have backpressure and limits</li>
            <li>Shared state avoided or sharded; short, observable critical sections</li>
            <li>Metrics include P95/P99 latency, queue depth, and contention</li>
          </ul>
        </>
      ),
      tone: 'positive',
    },
    {
      ...
      body: (
        <>
          <ul>
            <li>Unbounded goroutines/threads; growing queues and retry storms</li>
            <li>Global locks or hot MPMC queues without sharding</li>
            <li>Mixing async I/O with long CPU work on the same event loop</li>
            <li>No idempotency with retries; missing deadlines/budgets</li>
          </ul>
        </>
      ),
      tone: 'warning',
...
- Read [Latency, Throughput, Bandwidth](./latency-throughput-bandwidth)
- Explore [Producer–Consumer](../../design-patterns/concurrency-patterns/producer-consumer)
- Review [Thread Pool](../../design-patterns/concurrency-patterns/thread-pool)
- Study [Timeouts, Retries, Backoff, Jitter](../../distributed-systems-and-microservices/resilience-and-reliability-patterns/timeouts-retries-exponential-backoff-jitter)
- Understand [Idempotency](../../distributed-systems-and-microservices/fundamentals/idempotency)
