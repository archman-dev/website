...
description: "Describe the desired end state; let engines plan and execute—policy, inference, and reconciliation."
sidebar_position: 4
hide_title: true
---
...
<Head>
  <meta name="description" content="Describe the desired end state; let engines plan and execute—policy, inference, and reconciliation." />
  <meta property="og:title" content="Declarative & Logic Programming" />
  <meta property="og:description" content="Describe the desired end state; let engines plan and execute—policy, inference, and reconciliation." />
...
<Vs title="Declarative vs Imperative: When to Use Each"
  items={[
{
      label: "Declarative",
      points: [
