...
<Hero
  title="Procedural / Structured Programming"
  description="Disciplined control flow for linear workflows and I/O orchestration—when to use, when to reconsider"
  size="large"
/>
...
<Showcase
  ...
  tone="info"
  sections={[
    { label: 'Internal', body: "Read Object-Oriented, Functional, and Event-Driven and Reactive. See Influence on Architecture and Testing Strategy.", tone: "neutral" },
    { label: 'External', body: "Dijkstra: Notes on Structured Programming — foundational paper on structured control flow and program correctness.", tone: "neutral" }
  ]}
/>
